...
function Tile(props) {
  ...
  return (
   <div className="col-3" >
    <div className={"card " + cardStyle} onClick={() => props.click(loc)} style={{"margin": "5px", "height": "75px", "width": "75px", "textAlign": "center", "verticalAlign": "center", "lineHeight": "75px", "selfAlign" : "center"}} >
        {value}
    </div>
   </div>
  );
